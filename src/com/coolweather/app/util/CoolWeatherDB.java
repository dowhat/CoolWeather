...
import com.coolweather.app.db.CoolWeatherDatabaseHelper;
...
public class CoolWeatherDB {
	...
	// 将构造方法私有化 保证全局只会有一个CoolWeatherDB实例
	private CoolWeatherDB(Context context)
	{
		CoolWeatherDatabaseHelper dbHelper = new CoolWeatherDatabaseHelper(context, DB_NAME, null, VERSION);
	...
	public List<City> loadCities(int provinceId)
	{
		...
		Cursor cursor = db.query("City", null, "province_id = ?",
				new String[]{ Integer.toString(provinceId)}, null, null, null);
		if (cursor.moveToFirst())
		{
			do
			{
				City city = new City();
				city.setId(cursor.getInt(
	...
	public List<County> loadCounties(int cityId)
	{
		...
		Cursor cursor = db.query("County", null, "city_id = ?", 
				new String[]{ Integer.toString(cityId) }, null, null, null);
